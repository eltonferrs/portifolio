...
import { MenuNave } from '@/components/NaveMenu';
import { MenuMobile } from '@/components/NaveMenu/mobile';
import { BsGithub } from "react-icons/bs";

export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      <div className="w-9/12 flex flex-row items-center justify-between font-mono text-sm">
         <h1>Elton</h1>
         <MenuMobile/>
         <MenuNave />
      </div>
      <section className="w-9/12 flex min-h-screen flex-col items-center justify-between py-8 sm:p-16">
      <div className="flex items-center w-full justify-between gap-1 md:w-3/5">
        <img
